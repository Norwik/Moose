...
defmodule Orangutan.Context.UserContextTest do
  @moduledoc """
  User Context Test Cases
  """
  use Orangutan.DataCase
  alias Orangutan.Context.UserContext, as: UserContext
  ...
  describe "user_context" do
    ...
    test "create_user_meta/1 test cases" do
      ...
      assert result2.value == "orangutan"
      ...
      assert result3.value == "orangutan"
    ...
    test "update_user_meta/2 test cases" do
      ...
      assert result4.value == "orangutan"
